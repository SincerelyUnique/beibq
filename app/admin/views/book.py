...
def index():
    ...
    return render_template("admin/book/index.html", books=books, count_draft=count_draft, tab=tab)
...
def book_new():
    ...
    if form.validate_on_submit():
        book = Book.add(form.name.data, form.brief.data, form.access.data, current_user.id)
